...
// service_8hq9uxr
  ...
  return (
    <div
      className={`xl:mt-12 flex xl:flex-row flex-col-reverse gap-4 overflow-hidden h-[100vh]`}
    >
      <motion.div
  ...
  className='mt-18 flex flex-col gap-4' // Decreased the gap between inputs
>
  <label className='flex flex-col'>
    <span className='text-white font-medium mb-2'>Your Name</span> {/* Decreased the margin bottom */}
    <input
      type='text'
      name='name'
      value={form.name}
  ...
  >
    {loading ? "Sending..." : "Send"}
      ...
      <motion.div
        ...
        className='xl:flex-1 xl:h-auto md:h-[250px] h-[200px]'
      >
        <EarthCanvas />
      </motion.div>
    </div>
