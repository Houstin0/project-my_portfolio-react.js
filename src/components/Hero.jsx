      ...
      <div className="absolute inset-0 top-[60px] sm:top-[140px] pl-2 sm:pl-0 max-w-7xl mx-auto flex flex-row items-start gap-5">
        ...
        <div className="w-full sm:w-1/2 mt-7">
          ...
          <div className="mt-8 flex gap-4">
            <a href="https://github.com/Houstin0" target="_blank" rel="noopener noreferrer" className="bg-gray-800 dark:bg-gray-700 p-3 rounded-full flex justify-center items-center hover:bg-gray-600 dark:hover:bg-gray-600 transition-colors duration-300">
            ...
            <a href="https://www.linkedin.com/in/houstin-angwenyi-927a2120b/" target="_blank" rel="noopener noreferrer" className="bg-blue-700 dark:bg-blue-600 p-3 rounded-full flex justify-center items-center hover:bg-blue-500 dark:hover:bg-blue-500 transition-colors duration-300">
              <svg className="w-6 h-6 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
