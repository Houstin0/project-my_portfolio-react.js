...
const MatrixRainingCode = () => {
  ...
  return <canvas className="absolute top-0 left-0 w-full h-full" ref={canvasRef}></canvas>;
};
...
// const MatrixRainingCode = ({ isDarkMode }) => {
//   const canvasRef = useRef(null);
...
//       context.fillStyle = isDarkMode ? "rgba(0, 0, 0, 0.1)" : "rgba(255, 255, 255, 0.1)";
