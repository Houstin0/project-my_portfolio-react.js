...
const Services = () => {
  return (
    <section id="services" className="py-8 bg-gray-200">
      <div className="container mx-auto">
        ...
        <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          ...
          >
            <div className="bg-gray-100 shadow-md rounded-lg p-6 flex flex-col h-full">
              <img
          ...
          >
            <div className="bg-gray-100  shadow-md rounded-lg p-6 flex flex-col h-full">
              <img
                src="full-stack-development-icon.png"
